export type InputNodeType = "manual_trigger" | "crypto_price" | "market" | "bluesky_keyword";
...
export type BlueskyKeywordConfig = {
  handle: string;
  keyword: string;
...
export interface NodeDefinition {
  ...
  readonly blueskyKeywordConfig?: BlueskyKeywordConfig;
